...
| View | `hotel_app/views/` | Nhận request, kiểm tra quyền, gọi serializer/service, trả response |
| Template/Representation | `hotel_app/serializers/`, `core/api.py` | Validate dữ liệu và biểu diễn response JSON |
| Service | `hotel_app/services/` | Xử lý nghiệp vụ như booking, hóa đơn, báo cáo |
